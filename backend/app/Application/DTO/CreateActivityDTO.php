...
final class CreateActivityDTO extends BaseDTO
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'title' => $this->title,
            'slug' => $this->generateUniqueSlug($this->title, $this->slug),
    ...
    private function generateUniqueSlug(string $title, ?string $customSlug = null): string
    {
